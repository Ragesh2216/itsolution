...
const ExploreServices = () => {
  ...
  return (
    <div className="min-h-screen mt-16 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden">
      ...
      <section
        ref={heroRef}
        className={`relative min-h-screen mt-8 flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(0) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
      ...
      {/* Services Section - Alternative Design */}
      <section
        id="services"
        ref={servicesRef}
        className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(1) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-cyan-500/10 rounded-full mb-4 border border-blue-500/20">
              <div className="w-2 h-2 rounded-full bg-blue-400 animate-pulse"></div>
              <span className="text-blue-400 font-medium">Our Expertise</span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              <span className="relative">
                <span className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-cyan-500 blur-xl opacity-30"></span>
                <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400">
                  Technology Solutions
                </span>
              </span>
            </h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Transform your business with our innovative IT services
            </p>
          </div>

          {/* Grid Layout - Card Stack Effect */}
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative h-full">
                  {/* Background layers */}
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 opacity-80"></div>

                  {/* Border gradient layer */}
                  <div className={`absolute inset-0 rounded-2xl p-[1px] transition-all duration-500 ${activeService === service.id ? 'opacity-100' : 'opacity-0'
                    }`}>
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500"></div>
                  </div>

                  {/* Main card content */}
                  <div className={`relative rounded-2xl p-8 h-full transition-all duration-500 ${activeService === service.id
                      ? 'bg-gray-900/90 translate-y-[-4px]'
                      : 'bg-gray-900/50'
                    }`}>
                    {/* Icon with floating effect */}
                    <div className="relative mb-8">
                      <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${service.color} blur-xl transition-all duration-500 ${activeService === service.id ? 'opacity-50 scale-125' : 'opacity-30'
                        }`}></div>
                      <div className={`relative w-20 h-20 rounded-2xl bg-gradient-to-r ${service.color} flex items-center justify-center text-3xl transform transition-all duration-500 ${activeService === service.id
                          ? 'translate-y-[-8px] rotate-[5deg]'
                          : ''
                        }`}>
                        {service.icon}
                      </div>
                    ...
                    <div className="space-y-4">
                      <h3 className="text-2xl font-bold">
                        <span className="relative">
                          <span className={`absolute inset-0 bg-gradient-to-r ${service.color} blur-sm transition-all duration-500 ${activeService === service.id ? 'opacity-30' : 'opacity-0'
                            }`}></span>
                          <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">
                            {service.title}
                          </span>
                        </span>
                      </h3>
                      ...
                      {/* Hover indicator */}
                      <div className={`flex items-center justify-center pt-6 transition-all duration-500 ${activeService === service.id ? 'opacity-100' : 'opacity-0'
                        }`}>
                  ...
                  {/* Shadow effect */}
                  <div className={`absolute inset-0 rounded-2xl transition-all duration-500 ${activeService === service.id
                      ? 'bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-cyan-500/20 blur-xl -translate-y-2'
                      : 'bg-transparent'
                    }`}></div>
                </div>
              </div>
      ...
      <section
        ref={featuresRef}
        className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(2) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
        {/* Animated Background */}
      ...
      <section
        ref={technologiesRef}
        className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(3) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
      ...
      <section
        ref={processRef}
        className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(4) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
        {/* Animated Background */}
      ...
      <section
        ref={testimonialsRef}
        className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(5) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
      ...
      <section
        ref={partnersRef}
        className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(6) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
      ...
      <section
        ref={ctaRef}
        className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ${isSectionInView(7) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
      >
        {/* Animated Background */}
