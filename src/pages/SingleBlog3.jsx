...
const SingleBlog3 = () => {
  return (
    <main className="mt-8 px-4 sm:px-8 lg:px-24 py-12 bg-yellow-50">
      <section className="w-full max-w-4xl mx-auto">
          ...
          <div className="metaData flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 justify-center sm:justify-start">
            <div className="author flex items-center gap-3 justify-center sm:justify-start">
              <img
                ...
                alt="Ishan Sharma"
              />
              <h4 className="text-base font-semibold text-slate-800 hover:text-yellow-600 transition-colors">
                <Link to="/author/ishan-sharma">Ishan Sharma</Link>
              </h4>
            </div>
        ...
        <div className="blogCoverImg mt-8 rounded-2xl overflow-hidden shadow-lg">
          <img
            ...
            alt="Yellow camera - representing technology and innovation"
            loading="lazy"
          />
        </div>
        ...
        <div className="blogContent mt-8 max-w-3xl mx-auto">
          ...
          {/* Blockquote */}
          <div className="blockquote relative px-6 py-8 rounded-xl mt-6 bg-gradient-to-r from-yellow-500 to-amber-600 text-white shadow-lg">
          ...
          <div className="mt-8 p-6 bg-green-50 border border-green-200 rounded-xl">
            ...
            <p className="text-green-700 text-sm">
              This innovation in jute-based plastic alternatives represents a significant step forward 
              in sustainable technology and environmental conservation efforts in Bangladesh.
            </p>
          </div>
