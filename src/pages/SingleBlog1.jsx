...
const SingleBlog1 = () => {
  return (
    <main className="mt-8 px-4 sm:px-8 lg:px-20 py-12 bg-blue-50">
      <section className="w-full max-w-4xl mx-auto">
          ...
          <div className="metaData flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 justify-center sm:justify-start">
            <div className="author flex items-center gap-3 justify-center sm:justify-start">
              ...
              <h4 className="text-base font-semibold text-slate-800 hover:text-blue-600 transition-colors">
                <Link to="/author/harini-banerjee">Harini Banerjee</Link>
              </h4>
            </div>
        ...
        <div className="blogCoverImg mt-8 rounded-2xl overflow-hidden shadow-lg">
          <img
            ...
            alt="Girl standing by wall - representing mind-body connection and wellness"
            loading="lazy"
          />
        </div>
        ...
        <div className="blogContent mt-8 max-w-3xl mx-auto">
          ...
          {/* Blockquote */}
          <div className="blockquote relative px-6 py-8 rounded-xl mt-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-lg">
          ...
          <div className="mt-8 p-6 bg-indigo-50 border border-indigo-200 rounded-xl">
            <h4 className="text-lg font-semibold text-indigo-800 mb-2">🧠 Mind-Body Connection</h4>
            <p className="text-indigo-700 text-sm">
              This article beautifully illustrates the profound connection between mental and physical well-being. 
              Our thoughts and emotions directly impact our physical health, reminding us of the importance of 
              holistic self-care and mindfulness practices in our daily lives.
            </p>
          </div>
